...
#define MANUFACTURER    Rathur421
#define PRODUCT         Slice_it
...
#define MATRIX_ROW_PINS \
    { B1, B0, A7, A6, A5, A4 }
#define MATRIX_COL_PINS { B12, B13, B14, B15, A8, A9, A10, A11, A12, A15, B3, B4, B5, B6, B7}
#define UNUSED_PINS

/* encoder pins */
/* #define ENCODERS_PAD_A { C15 } */
/* #define ENCODERS_PAD_B {A3, A2, A1, A0} */
